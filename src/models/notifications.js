...
const NotificationSchema = new Schema({
  ...
  desde: {
    type: { calle: String, pais: String, ciudad: String },
    required: false,
  },
  hasta: {
    type: { calle: String, pais: String, ciudad: String },
  ...
  recibe: {
    type: { nombreApellidos: String, telefono: String, email: String },
    required: false,
  },
  driver: {
    _id: String,
    usuario: { type: UserSchema, required: false },
    desde: {
      type: { pais: String, ciudad: String, calle: String },
      required: false,
    },
    hasta: {
      type: { pais: String, ciudad: String, calle: String },
