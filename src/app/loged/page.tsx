...
const Loged = () => {
  ...
  return (
    <div className="flex flex-col w-full max-h-screen items-center bg-pink overflow-y-auto">
      ...
      {/* hola */}
      <div className="flex flex-col w-1/2 mx-auto items-center flex-wrap align-content-center overflow-y-auto fixed max-h-lvh top-40 left-5 right-5 bg-white border rounded-xl 2xl:top-48 2xl:w-1/3 2xl:min-h-80">
      ...
      <div className="flex flex-col items-center bg-pink sm:w-auto s:z-10">
        {fromModalOpen && (
          <div className="fixed top-0 z-10 left-0 right-0 bottom-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white pr-4 pl-4 rounded-xl overflow-y-scroll md:p-4 2xl:h-[500px] 2xl:w-[500px]">
              <MapComponent
        ...
        {receptor && (
          <div className="fixed top-0 z-10 left-0 right-0 bottom-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-4 rounded-xl h-[600px] overflow-y-scroll mb-20">
