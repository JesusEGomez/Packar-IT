  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='p-2 mx-auto'>
        <input className='p-2 bg-slate-200 rounded' type="text" placeholder="Ingrese una dirección" ref={inputRef} />
        <button className='bg-pink rounded mx-4 p-3 text-white text-sm' onClick={handleSearch}>Seleccionar</button>
      </div>
    </div>
  );
}
